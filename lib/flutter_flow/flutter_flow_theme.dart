...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFA42D11);
  late Color secondaryColor = const Color(0xFFAA5C1C);
  late Color tertiaryColor = const Color(0xFF700000);
  late Color alternate = const Color(0xFFB37509);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFF2F2);
  late Color primaryText = const Color(0xFF700000);
