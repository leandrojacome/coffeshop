...
class AppStateNotifier extends ChangeNotifier {
  CoffeshopFirebaseUser? initialUser;
  CoffeshopFirebaseUser? user;
  ...
  void update(CoffeshopFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'DetalheCesta',
              path: 'detalheCesta',
              builder: (context, params) => DetalheCestaWidget(
                cestaDetalhe: params.getParam('cestaDetalhe',
                    ParamType.DocumentReference, false, 'cestas'),
              ),
            ),
            FFRoute(
              name: 'Sacola',
            ...
            FFRoute(
              name: 'ListaEnderecos',
              path: 'listaEnderecos',
              builder: (context, params) => ListaEnderecosWidget(),
            ),
            FFRoute(
